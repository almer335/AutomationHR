...
webDriver.quit();
    ...
    public void mouseHoverElement(WebElement webElement) {
        executeScript("var element = arguments[0];"
                + "var mouseEventObj = document.createEvent('MouseEvents');"
                + "mouseEventObj.initEvent( 'mouseover', true, true );"
                + "element.dispatchEvent(mouseEventObj);", webElement);
        sleep(1);
    }

    public void forceClick(WebElement webElement){
        executeScript("function triggerMouseEvent (node, eventType) {"
                ...
                + "triggerMouseEvent (arguments[0], 'click');", webElement);
    }
